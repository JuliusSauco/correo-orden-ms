...
public class RestApiResponseEntityExceptionHandler extends CoreRestApiResponseEntityExceptionHandler {
	...
	@ExceptionHandler(es.correos.arq.correo_orden_ms.exceptions.EntityNotFoundException.class)
	public ResponseEntity<Object> handleElementNotFoundException(final es.correos.arq.correo_orden_ms.exceptions.EntityNotFoundException ex,
	...
	@ExceptionHandler(es.correos.arq.correo_orden_ms.exceptions.EntityExistsConflictException.class)
	public ResponseEntity<Object> handleExistsConflictException(
			final es.correos.arq.correo_orden_ms.exceptions.EntityExistsConflictException ex, final WebRequest request) {
