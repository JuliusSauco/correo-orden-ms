...
//		assertEquals("es.correos.arq.correo_orden_ms.exceptions.PlayerNotFoundException", ex.toString());
	}
...
//		assertEquals("es.correos.arq.correo_orden_ms.exceptions.PlayerNotFoundException: message", ex.toString());
	}
...
//		assertEquals("es.correos.arq.correo_orden_ms.exceptions.core.CorreosBusinessException: mensaje Business", ex.toString());
	}
