package es.correos.arq.correo_orden_ms.exceptions;
...
//		assertEquals("es.correos.arq.correo_orden_ms.exceptions.PlayerExistsConflictException", ex.toString());
	}
...
//		assertEquals("es.correos.arq.correo_orden_ms.exceptions.PlayerExistsConflictException: message", ex.toString());
	}
...
//		assertEquals("es.correos.arq.correo_orden_ms.exceptions.core.CorreosDAOException: mensaje DAO", ex.toString());
	}
