...
import es.correos.arq.correo_orden_ms.exceptions.PlayerExistsConflictException;
import es.correos.arq.correo_orden_ms.exceptions.PlayerNotFoundException;
...
public class RestApiResponseEntityExceptionHandlerTest {
	...
	public void testHandleElementNotFoundException() {
		es.correos.arq.correo_orden_ms.exceptions.EntityNotFoundException ex = new PlayerNotFoundException("Player not found");
	...
	public void testHandleExistsConflictException() {
		es.correos.arq.correo_orden_ms.exceptions.EntityExistsConflictException ex = new PlayerExistsConflictException(
				"Player not found");
		ResponseEntity<Object> responseEntity = this.restApiResponseEntityExceptionHandler
