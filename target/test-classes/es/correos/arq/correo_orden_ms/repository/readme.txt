...
@DataJpaTest
@EnableJpaRepositories(basePackages = "es.correos.arq.correo_orden_ms.repository", entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
